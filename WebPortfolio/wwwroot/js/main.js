...
jQuery(document).ready(function ($) {
    ...
    var modalContentData = {
        "mdv-intern": {
            ...
            "certificateLink": "https://unlimitedworks.blob.core.windows.net/conquest/MDV%20Certificate%20of%20Completion%20-%20Eric.pdf",
    ...
    $('#workExpModal').on('show.bs.modal', function (event) {
        ...
        modal.find('#modalCertificate').attr('href', data.certificateLink);
